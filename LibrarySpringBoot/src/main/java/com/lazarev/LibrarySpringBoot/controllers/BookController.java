package com.lazarev.LibrarySpringBoot.controllers;


import com.lazarev.LibrarySpringBoot.models.Book;
import com.lazarev.LibrarySpringBoot.models.Person;
import com.lazarev.LibrarySpringBoot.service.BookService;
...
public class BookController {
    ...
    public String index(Model model, @RequestParam(value = "page", required = false) Integer page,
        ...
        if (page == null || booksPerPage == null)
            model.addAttribute("books", bookService.showAll(sortByYear)); // выдача всех книг
        else
            model.addAttribute("books", bookService.showAllPagination(page, booksPerPage, sortByYear));
    ...
    public String makeSearch(Model model, @RequestParam("query") String query) {
        model.addAttribute("books", bookService.findByTittle(query));
        return "books/search";
    }
}
